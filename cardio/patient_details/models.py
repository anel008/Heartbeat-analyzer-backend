...
class Patient_details(models.Model):
    ...
    hyper_tension_bp = models.CharField(max_length=100, choices=YES_NO_CHOICES, default='no')  # Default added
    chest_pain = models.CharField(max_length=100, choices=YES_NO_CHOICES, default='no')  # Default added
    palpitation = models.CharField(max_length=100, choices=YES_NO_CHOICES, default='no')  # Default added
    surgery = models.CharField(max_length=100, choices=YES_NO_CHOICES, default='no')  # Default added
